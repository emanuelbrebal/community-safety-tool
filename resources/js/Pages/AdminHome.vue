...
const navigation = {
  ...
  contactAuthorities: (id) => {
    form.post(window.route("contactAuthorities", id));
  },
};
</script>
...
<template>
  ...
  >
    <div class="user-infos row mb-5">
      <div class="d-flex justify-content-between" id="author-content">
        ...
        <div>
          ...
          {{
            publication.anonymous
              ? "Não identificado"
              : publication.address.public_place + ", " + publication.address.number
          }}
        </div>
        <button
            ...
            <div class="modal-dialog">
              <div class="modal-content modal-update-users">
                  ...
                  <div v-if="publication.active">
                    <form>
                      <button
                        ...
                        @click.prevent="navigation.deactivatePublication(publication.id)"
                        data-bs-dismiss="modal"
                      >
                  ...
                  <div v-if="!publication.active">
                    <form>
                      <button
                        ...
                        @click.prevent="navigation.reactivatePublication(publication.id)"
                        data-bs-dismiss="modal"
                      >
                        Reativar Publicação
                      </button>
                ...
                <div class="modal-body border-top pt-3">
                  <h5>Contato com autoridades</h5>
                  <ul>
                    <li><strong>Polícia Militar:</strong> 190</li>
                    <li><strong>Bombeiros:</strong> 193</li>
                    <li><strong>SAMU (Atendimento Médico):</strong> 192</li>
                    <li><strong>Disque Denúncia:</strong> 181</li>
                    <li><strong>Delegacia da Mulher:</strong> 180</li>
                    <li><strong>Defesa Civil:</strong> 199</li>
                  </ul>
                  <button
                    type="button"
                    class="btn btn-outline-danger"
                    @click="navigation.contactAuthorities(publication.id)"
                    data-bs-dismiss="modal"
                  >
                    Entrar em Contato com Autoridades
                  </button>
                </div>
              </div>
            </div>
      ...
      <div>
        <div class="d-flex justify-content-end publication-date">
          Data de publicação:
