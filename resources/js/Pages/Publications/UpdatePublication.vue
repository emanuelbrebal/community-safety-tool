...
onMounted(() => {
  ...
  form.public_place = props.publication.address.public_place;
  form.number = props.publication.address.number;
  form.complement = props.publication.address.complement;
  form.image = props.publication.image;
...
<template>
  <div class="">
    <form class="px-4 py-3" @submit="submit(publication.id)" enctype="multipart/form-data">
      <div class="row mb-3">
      ...
      <hr />
        ...
        <div class="mb-3 row">
            <div class="col-md-2">
                ...
                <input type="date" class="form-control" v-model="form.incident_date"  />
            </div>
            <div class="col-md-2">
                <label for="incident_time">Hora do ocorrido</label>
                <input type="time" class="form-control" v-model="form.incident_time"  />
            </div>
        </div>
