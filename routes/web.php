...
Route::controller(RedirectController::class)->group(function () {
    Route::middleware(['loggedUserAttempt'])->group(function () {
        ...
        Route::get('admin/login', 'redirectLoginAdmin')->name('redirectLoginAdmin');
...
Route::middleware(['loggedUser'])->group(function () {
    Route::controller(PublicationController::class)->group(function () {
        ...
        Route::middleware(['OwnerOrAdminPublicationOwner'])->group(function () {
            Route::post('/update-publication-post/{id}', 'updatePublication')->name('updatePublication');
            Route::post('/contact-authorities/{id}', 'contactAuthorities')->name('contactAuthorities');
    ...
    Route::controller(RedirectController::class)->group(function () {
        ...
        Route::middleware(['OwnerOrAdminPublicationOwner'])->group(function () {
            Route::get('/update-publication/{id}', 'redirectUpdatePublication')->name('redirectUpdatePublication');
        });
    });
});
